...
Runs MUSCLE, trim-Al and IQ-TREE to obtain maximum likelihood gene trees for dN/dS computation.
#### run_pal2nal.sh
...
Runs pal2nal to output a "codon"-formatted output codon alignment, rather than paml output as in run_pal2nal.sh. This output format is used to compute the coordinates of the HGT interval for partitioned/fix-site models. 
